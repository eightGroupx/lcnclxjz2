	...
	<script type="text/javascript">
		$(window).load(function(){
			...
			$(".loading").fadeOut(300)
				...
				/*  $(function(){
					var url="${pageContext.request.contextPath}/house/selectAddress.action";
		    ...
		    $.ajax({  
		        url:"house/selectAddress.action",  
		        type:"post",  
		        dataType:"json",  
	...
	<body>
		...
		<div class="header clearfloat">
			...
			<header class="mui-bar mui-bar-nav">
		        ...
		        <select name="cityId" id="city" style="width:31px;height:25px;font-size:10px;color:gray;margin-top:15px;border: 0; background: transparent;" class="iconfont icon-iconfontarrowdown-copy">
		        </select>
		...
		<div id="main" class="mui-clearfix">
		    ...
		    <div class="cation clearfloat">
		    	<ul class="clearfloat">
		    		<li>
		    			<a  href="${pageContext.request.contextPath }/house/findAll.action?stocktypeId=1">
			    			<img src="img/fang.png" />
			    			<p>整租</p>
		    			</a>
		    		</li>
		    		<li>
		    			<a  href="${pageContext.request.contextPath }/house/findAll.action?stocktypeId=2">
			    			<img src="img/chuang.png" />
			    			<p>合租</p>
		    			</a>
		    		</li>
		    		<li>
		    			<a   href="${pageContext.request.contextPath }/house/findAll.action?stocktypeId=3&">
			    			<img src="img/bao.png" />
			    			<p>短租</p>
		    			</a>
		    		</li>
		    		<li>
		    			<a  href="${pageContext.request.contextPath }/house/findAll.action?stocktypeId=4">
			    			<img src="img/lou.png" />
			    			<p>写字楼</p>
		    			</a>
		    		</li>
		    		...
		    		<li>
		    			<a href="${pageContext.request.contextPath}/house/show.action">
	   ...
	   <footer class="page-footer fixed-footer" id="footer">
			<ul>
				...
				<li>
					<a href="${pageContext.request.contextPath}/house/showtwo.action">
